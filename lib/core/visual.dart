...
final visual = Visual.instance;

class Visual with HasGameData {
  static final instance = Visual._();
  ...
  Future<void> load() async => await storage.load('visual', this);

  // HasGameData

  @override
  void load_state(Map<String, dynamic> data) {
    _pixelate_screen = data['pixelate_screen'] ?? _pixelate_screen;
